...
private:
    ...
    /* »нструкци€ по использованию: можно инициализировать любое количество блоков блочной матрицы, блочные матрицы
    могут быть двух типов (диагональные или плотные) и состо€ть соответственно из блоков совего типа.
     аждый элемент блока становитс€ элементом единой блочной матрицы.*/

    std::vector<std::vector<MatrixType<T>*>> blocks;//инициализаци€ двумерной матрицы

    size_t _RowsBlock, _ColsBlock;//инициализаци€ количества строк и столбцов в блоке
